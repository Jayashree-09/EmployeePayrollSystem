...
public class ViewEmployeeFrame extends JFrame {
    ...
    private static final Color TBL_HEADER   = new Color(0x1E3A5F);
    private static final Color TBL_HDR_FG   = Color.WHITE;
    private static final Color ROW_ODD      = Color.WHITE;
    private static final Color ROW_EVEN     = new Color(0xF1F5F9);
    private static final Color ROW_SEL      = new Color(0xDCEDFB);
    private static final Color BORDER_COLOR = new Color(0xCBD5E1);
    private static final Color NEUTRAL      = new Color(0x64748B);
    private static final Color MALE_FG      = new Color(0x2563EB);  // indigo-600
    private static final Color FEMALE_FG    = new Color(0xDB2777);  // pink-600
    ...
    public ViewEmployeeFrame() {
        ...
        JLabel lblSub = new JLabel("All registered employees in the system");
        lblSub.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        lblSub.setForeground(new Color(0xBFDBFE));
        lblSub.setBounds(25, 38, 340, 18);
        header.add(lblSub);
        ...
        JLabel secLabel = new JLabel("EMPLOYEE LIST");
        ...
        // Alternating rows + gender color-coding
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable t, Object value,
                ...
                if (isSelected) {
                    ...
                    // Gender column colored
                    else if (col == 2 && value != null) {
                        String g = value.toString().toLowerCase();
                        setForeground(g.equals("female") ? FEMALE_FG : MALE_FG);
                        setFont(new Font("Segoe UI", Font.BOLD, 13));
                    } else {
        ...
        rowCountLabel.setText(model.getRowCount() + " employees found");
